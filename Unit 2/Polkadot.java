...
// modifier methods
 ...
 //    instance methods
   ...
   {
      double d = 10*Math.random(); //0-10, all doubles. Including 0, excluding 10
      int a = (int) (10*Math.random()); //0-9, all int, inclusive.
      int b = 10+ (int) (10*Math.random()); //10-19, all int, inclusive.
      int c = 20+ (int) (16*Math.random()); //20-35, all integers
